...
Developer-documentation engineer with twenty-five years in software. At Slack, wrote the developer documentation used across its platform: API references, SDK guides, and platform tutorials. Now builds and documents open-source tools on the Anthropic stack: MCP servers, Claude Code plugins, and agents, at www.ws-gong.com/code. Holds an MFA in Creative Writing; former fiction editor at Roxane Gay's The Rumpus.
